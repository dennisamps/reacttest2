...
class PercenS1to8 extends React.Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount() {
      this.myChart = new Chart(this.canvasRef.current, {
        ...
        options: {
            title: {
                display: true,
                text: 'Average Percentile of Sheet 1-8 of When students opened the sheets after Lecture',
                fontSize: 25
            },
            scales: {
                xAxes: [{
                ...
                yAxes: [{
                    ...
                    scaleLabel: {
                        display: true,
                        labelString: 'Average Percentile of Sheet 1-8'
                    }
                }]
            },
            legend: {
