    ...
    componentDidMount() {
      this.myChart = new Chart(this.canvasRef.current, {
        ...
        options: {
            title: {
                display: true,
                text: 'Correlation between Start Times after Lecture Sheets 1-8 and Progress Marks',
                fontSize: 25
            },
            scales: {
                xAxes: [{
                ...
                yAxes: [{
                    ...
                    scaleLabel: {
                        display: true,
                        labelString: 'Standard Deviation Of Start times after Lecture for Sheet 1-8'
                    }
                }]
            },
            legend: {
